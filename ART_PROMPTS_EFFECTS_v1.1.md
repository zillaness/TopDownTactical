---
file: ART_PROMPTS_EFFECTS_v1.1.md (top-down-tactical)
version: 1.1
author: Sam Cao
created: 2026-08-15
...
Send sheets at whatever size the model returns — I slice them, resolve the
alpha (native, or keyed if it fell back to magenta), and wire the timing in the
engine. Use exactly the filenames given.
