...
**Play:** open `top_down_tactical_v0.58.html` in a browser. Everything is one
...
| File | What it is |
|---|---|
| `top_down_tactical_v0.58.html` | The game (single file, canvas 2D) |
...
- v1.50 (2026-08-16): Synced to v0.53 — ten vehicle bodies with armour live, nine authored effects on their own frame timings, grenades with a shape, and 373 props and shrubs across nineteen maps.
- v1.51 (2026-08-16): Synced to v0.54 — pulled the scattered props back out; they were placed in open ground and read as litter.
- v1.52 (2026-08-16): Synced to v0.55 — damage from a second direction adds to a car instead of replacing what the first direction did.
- v1.53 (2026-08-16): Synced to v0.56 — the face swap costs a rung, heavy damage draws heavy art, and an all-round shot-up slot lands per body.
- v1.54 (2026-08-16): Synced to v0.57 — all-round shot-up art for all ten bodies; a car hit from two directions now looks it.
- v1.55 (2026-08-16): Synced to v0.58 — tree canopies draw above the fog, like the cars and props already did.
