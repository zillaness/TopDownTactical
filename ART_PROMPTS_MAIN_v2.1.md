---
file: ART_PROMPTS_MAIN_v2.1.md (top-down-tactical)
version: 2.1
author: Sam Cao
created: 2026-08-15
...
- **Cars** — all twelve vehicles, the battle-damage ladder and the damage
  overlays live in `ART_PROMPTS_CARS_v1.1.md`.
- **Explosions and animation** — the nine sprite sheets live in
  `ART_PROMPTS_EFFECTS_v1.1.md`.
...
| 2 vehicles — *separate thread, see `ART_PROMPTS_CARS_v1.1.md`* | 25 |
